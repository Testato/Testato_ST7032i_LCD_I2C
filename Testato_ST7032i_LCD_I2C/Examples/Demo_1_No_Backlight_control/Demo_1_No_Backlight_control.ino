...
// Double Font
  lcd.clear();
  lcd.setCursor(0,0);  lcd.print("Double");  
  lcd.setCursor(0,1);  lcd.print("Font");  delay(1500);
  lcd.setDoubleFont();
  lcd.setCursor(0,0);  lcd.print("Double Font");   delay(3000);
  lcd.setSingleFont(); // return to single Font
