...
#ifndef Testato_ST7032i_LCD_I2C_h
#define Testato_ST7032i_LCD_I2C_h
...
public:
  LiquidCrystal_I2C_ST7032i(uint8_t lib_Used,uint8_t lcd_Addr,uint8_t lcd_cols,uint8_t lcd_rows);	// for instantiation without Arduino pin for backlight control
  LiquidCrystal_I2C_ST7032i(uint8_t lib_Used,uint8_t lcd_Addr,uint8_t lcd_cols,uint8_t lcd_rows,uint8_t lcd_backlightpin);	// for instantiation with Arduino pin for backlight control
  LiquidCrystal_I2C_ST7032i(uint8_t lib_Used,uint8_t lcd_Addr,uint8_t lcd_cols,uint8_t lcd_rows,SoftI2CMaster i2csw);		// I2Csw - no backlight
  LiquidCrystal_I2C_ST7032i(uint8_t lib_Used,uint8_t lcd_Addr,uint8_t lcd_cols,uint8_t lcd_rows,uint8_t lcd_backlightpin,SoftI2CMaster i2csw); // I2Csw + backlight
...
private:
  ...
  uint8_t _pwm;
  SoftI2CMaster _i2csw;
};

#endif // Testato_ST7032i_LCD_I2C_h
